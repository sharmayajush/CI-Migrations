...
func upCiSchemaUpdate(tx *sql.Tx) error {
	...
	if _, err := tx.Exec(`
	ALTER TABLE cwpp.channels RENAME TO old_channels;
	ALTER TABLE cwpp.channel_slack_settings RENAME TO old_channel_slack_settings;
	ALTER TABLE cwpp.channel_splunk_settings RENAME TO old_channel_splunk_settings;
	ALTER TABLE cwpp.channel_cloudwatch_settings RENAME TO old_channel_cloudwatch_settings;
	ALTER TABLE cwpp.channel_jira_settings RENAME TO old_channel_jira_settings;
	ALTER TABLE cwpp.channel_rsyslog_settings RENAME TO old_channel_rsyslog_settings;
...
func downCiSchemaUpdate(tx *sql.Tx) error {
	...
	ALTER TABLE cwpp.old_channels RENAME TO channels;
	ALTER TABLE cwpp.old_channel_slack_settings RENAME TO channel_slack_settings;
	ALTER TABLE cwpp.old_channel_splunk_settings RENAME TO channel_splunk_settings;
	ALTER TABLE cwpp.old_channel_cloudwatch_settings RENAME TO channel_cloudwatch_settings;
	ALTER TABLE cwpp.old_channel_jira_settings RENAME TO channel_jira_settings;
	ALTER TABLE cwpp.old_channel_rsyslog_settings RENAME TO channel_rsyslog_settings;
	`); err != nil {
		return err
	}
	return nil
